...
<head>
    ...
    <title>Layanan Nasabah | BPR Danamas Belu</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="canonical" href="https://bprdanamasbelu.com/page/view/8--layanan-nasabah" />

    <meta name="title" content="Layanan Nasabah | BPR Danamas Belu" />
    ...
    <meta property="og:title" content="Layanan Nasabah | BPR Danamas Belu" name="title"/>
    <meta property="og:description" name="description" content="Official Website of BPR Danamas Belu" />
    <meta property="og:url" name="url" content="https://bprdanamasbelu.com/page/view/8--layanan-nasabah" />
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="main-title">
                            <h1 class="title">Layanan Nasabah</h1>
                        </div>
                    </div><!-- col -->
                </div><!-- row -->
            </div><!-- container -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-12">
                        <article class="single-post">
                            <p>BPR Danamas Belu Juga Melayani&nbsp;</p>
                            <p>1 Pembayaran Uang Sekolah Untuk SDK Sta. Theresia Atambua II.</p>                    </article>
                        </div>
                    </div><!-- row -->
                </div><!-- container -->
            </section>
