...
<head>
    ...
    <title>Berita | BPR Danamas Belu</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="canonical" href="https://bprdanamasbelu.com/post/section/1--berita" />

    <meta name="title" content="Berita | BPR Danamas Belu" />
    ...
    <meta property="og:title" content="Berita | BPR Danamas Belu" name="title"/>
    <meta property="og:description" name="description" content="Official Website of BPR Danamas Belu" />
    <meta property="og:url" name="url" content="https://bprdanamasbelu.com/post/section/1--berita" />
...
<body>
    ...
    <section class="content-wrap">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="single-article">
                    <a href="detail_berita.php">
                        <div class="box-img">
                            <div class="thumb">
                                <img src="img/berita/squares.jpg">
                            </div>
                        </div><!-- box-img -->
                        <div class="single-desc">
                            <span class="text-label">02 Mar 2022</span>
                            <h1 class="single-title">Ada 61 BPR Sudah Daftar Beri Keringanan Kredit</h1>
                        </div>
                    </a>
                </div><!-- single-article -->
            </div><!-- col -->
        ...
        <nav class="pagination-nav">
            	                <!-- <span class="text-label">Displaying 8 of 32</span>
                <ul class="pagination">
