...
<head>
    ...
    <title>Pengaduan Nasabah | BPR Danamas Belu</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="canonical" href="https://bprdanamasbelu.com/page/view/9--pengaduan-nasabah" />

    <meta name="title" content="Pengaduan Nasabah | BPR Danamas Belu" />
    ...
    <meta property="og:title" content="Pengaduan Nasabah | BPR Danamas Belu" name="title"/>
    <meta property="og:description" name="description" content="Official Website of BPR Danamas Belu" />
    <meta property="og:url" name="url" content="https://bprdanamasbelu.com/page/view/9--pengaduan-nasabah" />
    ...
    <div id="main">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="main-title">
                            <h1 class="title">Pengaduan Nasabah</h1>
                        </div>
                    </div><!-- col -->
                </div><!-- row -->
            </div><!-- container -->
        ...
        <section class="content-wrap">
            <div class="container">
                <div class="row">
                    <?php  
                    include 'layanan_aside.php';
                    ?>
                    <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-12">
                        <article class="single-post">
                            <p>Content Pengaduan Nasabah</p>
                            <p>Pemberitahuan Kepada Seluruh Nasabah BANK PERKREDITAN RAKYAT DANAMAS BELU jika ingin melakukan pengaduan segera hubungi Customer Service Kami dengan bisa menghubungi lewat WhatsApp dan layanan telepon di nomor: 0812-4669-1559</p>                    </article>
                        </div>
                    </div><!-- row -->
                </div><!-- container -->
            </section>
