<footer class="main-footer">
    <section class="content-wrap top-footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 footer-wrap">
                    <a class="logo-footer" href="https://bprdanamasbelu.com/"><img src="https://bprdanamasbelu.com/tmplts/danamas/assets/images/bpr_logo.svg"></a>
                </div><!-- col -->
                <div class="col-lg-3 col-lg-offset-1 col-md-3 col-md-offset-1 footer-wrap">
                    <div class="main-title">
                        <h5 class="title">Perusahaan</h5>
                    </div>
                    <ul class="footer-nav">
                        <li><a href="https://bprdanamasbelu.com/page/view/1--tentang-kami">Tentang Kami</a></li>
                        <li><a href="https://bprdanamasbelu.com/form/view/1--kontak">Kontak Kami</a></li>
                        <li><a href="https://bprdanamasbelu.com/post/section/1--berita">Informasi</a></li>
                        <li><a href="https://bprdanamasbelu.com/page/view/11--karir">Karir</a></li>
                    </ul>
                </div><!-- col -->
                <div class="col-lg-3 col-md-3 footer-wrap">
                    <div class="main-title">
                        <h5 class="title">Produk Kami</h5>
                    </div>
                    <ul class="footer-nav">
                        <li><a href="https://bprdanamasbelu.com/page/view/3--tabungan">Tabungan</a></li>
                        <li><a href="https://bprdanamasbelu.com/page/view/4--deposito">Deposito</a></li>
                        <li><a href="https://bprdanamasbelu.com/page/view/5--kredit">Kredit</a></li>
                    </ul>
                </div><!-- col -->
                <div class="col-lg-3 col-md-3 footer-wrap">
                    <div class="main-title">
        ...
        <h5 class="title" style="color: white;"><marquee>"BPR Danamas Belu Bersama Kita Maju"</marquee></h5>
    </section><!-- top-footer -->
    <section class="bottom-footer">
        <div class="container">
            <div class="copyright">© BPR Danamas Belu 2018. Developed By
                <a href="http://4visionmedia.com" class="logo-4vm">
